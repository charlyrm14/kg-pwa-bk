...
class UserPolicy
{
    ...
    /**
     * The function `viewMonthlyAttendances` determines if a user can view the progress of another user based on
     * their roles.
     *
     * @param User authUser The `authUser` parameter represents the authenticated user who is trying to
     * view the progress of another user. This user could be an admin or a regular user.
     * @param User targetUser The `viewMonthlyAttendances` function takes two parameters: `` and
     * ``. The `` parameter represents the authenticated user who is trying to view
     * the progress, and the `` parameter represents the user whose progress is being
     * viewed.
     *
     * @return bool The `viewMonthlyAttendances` function returns a boolean value. It returns `true` if the
     * authenticated user is an admin or if the authenticated user is trying to view their own
     * progress. Otherwise, it returns `false`.
     */
    public function viewMonthlyAttendances(User $authUser, User $targetUser): bool
    {
        // Admin puede ver cualquiera
        if ($authUser->role_id === 1) {
            return true;
    ...
    /**
     * The function `viewUserSchedule` determines if a user can view the progress of another user based on
     * their roles.
     *
     * @param User authUser The `authUser` parameter represents the authenticated user who is trying to
     * view the progress of another user. This user could be an admin or a regular user.
     * @param User targetUser The `viewUserSchedule` function takes two parameters: `` and
     * ``. The `` parameter represents the authenticated user who is trying to view
     * the progress, and the `` parameter represents the user whose progress is being
     * viewed.
     *
     * @return bool The `viewUserSchedule` function returns a boolean value. It returns `true` if the
     * authenticated user is an admin or if the authenticated user is trying to view their own
     * progress. Otherwise, it returns `false`.
     */
    public function viewUserSchedule(User $authUser, User $targetUser): bool
    {
        // Admin puede ver cualquiera
        if ($authUser->role_id === 1) {
            return true;
     ...
     * progress. Otherwise, it returns `false`.
     */
    public function viewStudentProgram(User $authUser, User $targetUser): bool
    {
        // Admin puede ver cualquiera
        if ($authUser->role_id === 1) {
            return true;
